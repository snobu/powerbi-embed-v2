...
// Be careful how you're calling the Azure Function in PROD.
// Always authenticate the user first in your frontend,
// otherwise anyone with the Function-Level-Authorization-Token
// can call your backend and get a valid embed token.
// The better approach would be to use the built-in Azure AD
// authentication feature in App Service (called EasyAuth)
// and have authenticated calls to both the frontend Web App and
// the Function App.
